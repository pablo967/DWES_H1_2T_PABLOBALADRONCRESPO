...
public class DatabaseWebSecurity  {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers("/admin").hasAuthority("ADMINISTRADOR") // Solo ADMIN puede acceder a admin
                .requestMatchers("/conductor").hasAuthority("CONDUCTOR") // Solo CONDUCTOR puede acceder a conductor
                .anyRequest().authenticated());
        //http.formLogin(formLog  in -> formLogin.loginPage("/login").permitAll());
